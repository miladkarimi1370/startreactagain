            ...
            <hr style={{ backgroundColor: CYAN }} />
            {
                loading ? <Spinner /> :
                    Object.keys(contact).length > 0 && (
                        <section className="vew-contact mt-e">
                            <div className="container p-2" style={{ backgroundColor: CURRENTLINE, borderRadius: "1rem" }}>
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-md-9">
                                        <ul className="list-group">
                                            ...
                                            <li className="list-group-item list-group-item-dark">
                                                گروه  : {" "}
                                                <span className="fw-bold">{contact.group && groups.map((c) => {
                                                    if (c.id === contact.group) {
                                                        return c.catefory
                                                    }
                                                })}</span>
                                            </li>
